                    ...
                    <form enctype="multipart/form-data" action="{{ route('courses.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ old('name') }}" class="@error('name') is-invalid @enderror form-control form-control-lg" id="name" name="name"
                            ...
                            <div class="mb-4">
                                ...
                                <textarea rows="5" class="form-control form-control-lg" id="description"
                                    name="description" placeholder='Course Description'>{{ old('description') }}</textarea>
                            </div>
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-lg btn-primary fw-bold" id="create-btn">Add Course</button>
                            </div>
                        </div>
                    </form>
                </div>
